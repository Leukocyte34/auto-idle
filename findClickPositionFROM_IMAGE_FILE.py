...
def findClickPositions(needle_img_path, fightscreen_img_path, threshold = 0.5, debug_mode=None):
    fightscreen_img = cv.imread(fightscreen_img_path, cv.IMREAD_UNCHANGED)
    ...
    if len(rectangles):
        ...
        for (x, y, w, h) in rectangles:
            ...
            if debug_mode == 'rectangles':
                ...
                cv.rectangle(fightscreen_img, top_left, bottom_right,color=line_color, lineType=line_type, thickness=2)
